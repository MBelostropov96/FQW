...
<?php if (isset($_SESSION['id_users'])): ?>
    ...
    <div class="container service service-contract">
        <div class="contract_check">
            <object data="<?=BASE_URL?>tcpdf/contracts_product/Dogovor_<?=$post_contract?>.pdf"
            ...
            <div class="accordion accordion_contract" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <form method="post" action="user_contract_check_prod.php" enctype="multipart/form-data">
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body b-1">
                                <div class="row row-info-new">
                                    ...
                                    <input name="cont" class="form-control input-img w-50" type="file" id="formFile">
                                    <div class="form-text">

                                    </div>
                                    <input name="id_cont" value="<?=$post_contract?>" type="hidden">
                                </div>
                                <div class="w-100"></div>
                                <div>
                                    <button name="update-contract" type="submit" class="btn btn-outline-secondary button-new-message mt-3">Отправить договор</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body b-2">
                            <form method="post" action="user_contract_check_prod.php" class="mb-1">
                                ...
                                <div class="pad-2">
                                    ...
                                    <div class="mt-4">
                                        <input name="theme" value="Правки в договор №<?=$post_contract?>" type="hidden">
                                    ...
                                    <div>
                                        <button name="button-new-message" type="submit" class="btn btn-outline-secondary button-new-message">Отправить сообщение</button>
                                    </div>
                                </div>
                            </form>
                        </div>
