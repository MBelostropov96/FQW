...
<?php if (isset($_SESSION['id_users'])): ?>
    ...
    <div class="container service service-contract">
        <div class="row contract">
            <form class="row contract-block" method="post" action="form_product_contract.php">
                <input name="number_app_prod" value="<?=$post_service?>" type="hidden">
                <h2>
                ...
                <div class="row">
                    <button type="submit" class="btn btn-outline-secondary col-md-6" name="button-product-contract">Отправить данные</button>
                </div>
            </form>
        </div>
    </div>
