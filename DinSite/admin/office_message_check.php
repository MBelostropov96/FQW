                ...
                <div class="col-9 right-message">
                    <div class="container shell-message">
                        <div class="mes-check">
                            ...
                            <div class="form-message-refactor p-3">
                        ...
                        <form action="office_message_new.php" method="post">
                                <div class="row row-edit">
                                    <div>
                                        <button onclick="location.href = '<?php echo BASE_URL . 'admin/office_message_new.php'?>'" name="but-mes-answer" type="submit" class="btn btn-success but-mes-answer">Ответить</button>
                    ...
                    <div class="mes-back">
                        <a href="<?php echo BASE_URL . 'admin/office_message.php'?>"><i class="fa-solid fa-arrow-left"></i></i>&nbsp;Назад</a>
                    </div>
                </div>
            </div>
        </div>
