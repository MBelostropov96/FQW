                    ...
                    <div class="container shell-message">
                        <form action="admin_message_new.php" method="post" class="p-3">
                            <div class="mes-check">
                                ...
                                <div class="mb-3">
                                    <p>
                                        <strong>От кого: </strong><?=$theme?><br>
                                ...
                                <div class="row row-edit">
                                    ...
                                    <div>
                                        ...
                                        <input name="answer_email"  value="<?=$theme?>" type="hidden">
                                    </div>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="mes-back ms-3">
                        <a href="<?php echo BASE_URL . 'admin/admin_message_feedback.php'?>"><i class="fa-solid fa-arrow-left"></i></i>&nbsp;Назад</a>
                    </div>
                </div>
            </div>
        </div>
