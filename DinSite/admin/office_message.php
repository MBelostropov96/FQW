                    ...
                    <div class="container shell-message">
                        ...
                        <div class="row row-mes">
                            ...
                            <div class="col-2 for-link">
                                <button onclick="location.href = '<?php echo BASE_URL . 'admin/office_message_check.php?id=' . $message['id_message']?>'" name="but-check" type="submit" class="btn btn-success but-check">Прочитать</button>
                            </div>
