        ...
        <div class="container body-admin">
            <div class="row">
                ...
                <div class="col-9 right-message">
                    <form method="post" action="admin_news_new.php" enctype="multipart/form-data">
                        <div class="container shell-message">
                            ...
                            <div class="row row-info-new mb-2">
                                <p>Текст</p>
                                <textarea name="text-new"  class="form-control form-control-prod-2" id="exampleFormControlTextarea1" rows="5""></textarea>
                            </div>
                            <div class="row row-info-new mb-5">
                                <label for="formFile" class="form-label">Добавить фото</label>
                                <input name="img-new" class="form-control form-control-prod-4" type="file" id="formFile">
                                <div class="form-text">

                                </div>
                            </div>
                            <div>
                                <button type="submit" class="btn btn-outline-secondary col-md-4 button-new-message" name="button-new-news">Опубликовать</button>
                            </div>
                        </div>
                    </form>
                </div>
