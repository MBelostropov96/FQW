 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
//define ('K_PATH_IMAGES', 'assets/images/prod/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Delavego');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Delavego');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Мой сайт');

/**
 * Header description string.
 */
//define ('PDF_HEADER_STRING', "Шапка?");
